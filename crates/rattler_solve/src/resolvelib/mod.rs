...
impl ResolvelibBackend {
    ...
    pub fn solve<'a>(
        ...
        let mut result = resolver
            ...
            .map_err(|err| {
                let msgs = match err {
                    ResolutionError::ResolutionImpossible(err) => {
                        // TODO: remove graphviz printing
                        let graphviz = err.graph().graphviz(
                            |record| {
                                format!(
                                    "{}{}",
                    ...
                    ResolutionError::ResolutionTooDeep(_) => "resolution too deep".to_string(),
                };
